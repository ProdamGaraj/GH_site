...
Реализовано: Ctrl+Z / Ctrl+Y (undo/redo), Ctrl+колесо (zoom 25–500%),
Space+перетаскивание (pan холста).

Не реализовано: Ctrl+S (сохранение — работает автосейв), Delete,
Ctrl+D, Ctrl+C / Ctrl+V. См. KNOWN_ISSUES.md, C1 и feature-inventory M2.
